	...
	<div class="wrapper">
		<div class="nav">
			<ul class="topnav">
				...
				<li id="icon"><a href="#toggle">&#9776;</a></li>
			</ul>
		</div>
		<div class="hero" id="home">
			<h1>Crown And Eagle</h1>
		...
		<div class="about-us container" id="aboutus">
			<h1>About Us</h1>
			<p>We share your passion. Advice is freely given.</p>
			<p class="info">Crown and Eagle was founded in 1984 primarily as a coin and stamp collection shop. In June of 2012, new management took over and expanded into a precious metals. Our current staff has over 60 plus years combined of numismatic experience. We also provide written insurance and estate appraisals. 
			<br>
			<br>
			...
			<br>
			<br>
			Our showroom features collectible coins, coin collector supplies, paper money, stamps and other collectible items in a safe, secure environment.</p>
		</div>
		<div class="appraisals container" id="appraisals">
			<h1>Appraisals</h1>
			<p>Crown and Eagle offers appraisals for you collection</p>
			<p class="info">Coin Pricing Coin enthusiasts use four different terms when referring to coin values. 
				<br>
				<br>
